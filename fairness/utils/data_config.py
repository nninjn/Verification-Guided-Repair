class adult:
    ...
    # Feature names (hyphens converted to underscores)
    feature_name = [
    ...
    # Categorical feature indices (all features in this configuration)
...
class credit:
    ...
    sensitive_feature = {"age": 12, "sex": 8, "gender": 8}
    # the name of each class
    class_name = ["bad", "good"]
...
class compas:
    ...
    feature_name = ["sex", "age", "race", "att4", "att5", "att6", "att7", "att8", "att9", "att10",
                                                                      "att11", "att12"]
    sensitive_feature = {"age": 1, "race": 2, "sex": 0, "gender": 0}
    # the name of each class
    class_name = ["no", "yes"]
...
class default:
    ...
    sensitive_feature = {"age": 4, "sex": 1, "gender": 1}
    # the name of each class
    class_name = ["no", "yes"]
...
class heart:
    ...
    feature_name = ["age", "sex", "cp", "trestbps", "chol", "fbs", "restecg", "thalach", "exang", "oldpeak",
                                                                      "slope", "ca", "thal"]
    sensitive_feature = {"age": 0, "sex": 1, "gender": 1}
    # the name of each class
    class_name = ["not disease", "disease"]
...
class students:
    ...
    sensitive_feature = {"age": 2, "sex": 1, "gender": 1}
    # the name of each class
...
class meps15:
    ...
    sensitive_feature = {"age": 0, "race": 1, "sex": 9, "gender": 9}
    # the name of each class
    class_name = ["no", "yes"]
