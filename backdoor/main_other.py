...
parse.add_argument('--act', type=str, default='gelu')
...
log.propagate = False
if args.log:
    results_dir = f'results/Ours/'
    if not os.path.exists(results_dir):
        os.makedirs(results_dir)
    file_handler = logging.FileHandler(f"{results_dir}/{args.dataset}_{args.attack}_{args.act}.log", "a")
else:
...
n_classes, target, poisoned_model, clean_test_dataset, bd_test_dataset = data_model(dataset=dataset, attack=attack, act=args.act)
